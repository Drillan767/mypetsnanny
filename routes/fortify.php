...
Route::group(['middleware' => config('fortify.middleware', ['web'])], function () {
    ...
    if (Features::enabled(Features::resetPasswords())) {
        Route::get('/reinitialiser-mot-de-passe', [PasswordResetLinkController::class, 'create'])
            ->middleware(['guest'])
    ...
    Route::get('/profil/confirmer-mot-de-passe', [ConfirmablePasswordController::class, 'show'])
        ->middleware(['auth'])
    ...
    Route::get('/profil/statut-mot-de-passe', [ConfirmedPasswordStatusController::class, 'show'])
        ->middleware(['auth'])
